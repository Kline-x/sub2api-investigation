...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/patrol/records", h.Admin.Account.ListAccountPatrolRecords)
		accounts.DELETE("/patrol/records", h.Admin.Account.DeleteAllAccountPatrolRecords)
		accounts.DELETE("/patrol/records/:id", h.Admin.Account.DeleteAccountPatrolRecord)
		...
		accounts.POST("/:id/clear-error", h.Admin.Account.ClearError)
			accounts.POST("/:id/set-error", h.Admin.Account.SetError)
		...
		accounts.POST("/batch-clear-error", h.Admin.Account.BatchClearError)
			accounts.POST("/batch-set-error", h.Admin.Account.BatchSetError)
...
func registerProxyRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	proxies := admin.Group("/proxies")
	{
		...
		proxies.POST("/import-subscription", h.Admin.Proxy.ImportSubscription)
