...
const GITHUB_REPO = 'Kline-x/sub2api-investigation'
// GHCR image published by CI (tags carry no "v" prefix, e.g. ghcr.io/kline-x/sub2api:0.1.156-custom.1)
const DOCKER_IMAGE = 'ghcr.io/kline-x/sub2api'
