export default {
  ...
  version: {
    ...
    upstreamSection: 'Official Upstream',
    upstreamLatest: 'Official latest',
    upstreamBehindHint: 'A newer official release is available (notice only; does not auto-update this custom build).',
    upstreamInSync: 'Aligned with official baseline',
    viewUpstreamRelease: 'View official release',
    viewUpstreamChangelog: 'View official changelog',
