export default {
    accounts: {
      ...
      dataImportPipelineScheduled: '{count} grok account(s) queued for background token refresh + test; failures become temporarily unschedulable',
    ...
    recordsDeleteConfirm: 'Delete this patrol record?',
    recordsClearAll: 'Clear all',
    recordsClearAllConfirm: 'Clear all patrol records? This cannot be undone.',
    recordsDeleted: 'Deleted',
    recordsCleared: 'Cleared {count} record(s)',
    recordsDeleteFailed: 'Delete failed',
    recordsRetentionHint: 'Records are kept for 7 days and then auto-cleaned.',
  ...
  upstreamBilling: {
      ...
      bulkActions: {
        ...
        selectAllFiltered: 'Select all {count} matching accounts',
        selectingAll: 'Selecting...',
        allFilteredSelected: 'All {count} matching accounts selected',
        ...
        setError: 'Mark as Error',
        setErrorConfirm: 'Mark the selected {count} account(s) as error? They will stop scheduling until cleared.',
        setErrorSuccess: 'Marked {count} account(s) as error',
        refreshToken: 'Refresh Token',
        test: 'Batch Test',
        testSuccess: 'Tested {count} account(s), all passed',
        testCompletedWithFailures: 'Batch test finished: {success} passed, {failed} failed (failed accounts temporarily unschedulable)',
        testDialogTitle: 'Batch Test',
        testDialogHint: 'Pick a test model per platform. Leave empty to use platform defaults.',
        testDialogConfirm: 'Start Test',
        testDialogLoadingModels: 'Loading models...',
        testDialogNoModels: 'No models available; platform default will be used',
        probeUpstreamBilling: 'Probe Upstream Billing',
        probingUpstreamBilling: 'Probing upstream billing...',
      ...
      bulkEdit: {
        ...
        expiresAtRequired: 'Select an expiration time or choose Never expires',
      ...
      setError: 'Mark as Error',
      setErrorConfirm: 'Mark account "{name}" as error? It will stop scheduling until cleared.',
      setErrorSuccess: 'Account marked as error',
      setErrorFailed: 'Failed to mark account as error',
