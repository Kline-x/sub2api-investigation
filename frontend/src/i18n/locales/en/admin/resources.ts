export default {
    ...
    proxies: {
      ...
      // Subscription import
      importSubscription: 'Import from Subscription',
      importSubscriptionTitle: 'Import Proxies from Subscription',
      importSubscriptionHint: 'Paste an airport subscription URL (Clash format). Only Shadowsocks (ss) nodes are supported; other node types will be skipped with a reason. The URL contains a secret key, so do not share it.',
      importSubscriptionUrlLabel: 'Subscription URL',
      importSubscriptionUrlPlaceholder: 'Paste subscription URL',
      importSubscriptionUrlRequired: 'Please enter a subscription URL',
      importSubscriptionPreview: 'Preview',
      importSubscriptionPreviewing: 'Previewing...',
      importSubscriptionBack: 'Back',
      importSubscriptionConfirm: 'Confirm Import',
      importSubscriptionImporting: 'Importing...',
      importSubscriptionPreviewSummary: 'Preview: {created} to be created, {updated} already exist',
      importSubscriptionSkippedTitle: 'Unsupported, {count} skipped',
      importSubscriptionDone: 'Import completed: {created} created, {updated} already existed',
      importSubscriptionFailed: 'Failed to import subscription',
      importSubscriptionPreviewFailed: 'Failed to preview subscription',
      importSubscriptionClose: 'Done',
