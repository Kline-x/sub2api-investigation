export default {
    ...
    proxies: {
      ...
      // 机场订阅导入
      importSubscription: '从订阅导入',
      importSubscriptionTitle: '从订阅导入代理',
      importSubscriptionHint: '粘贴机场订阅链接（Clash 格式），仅支持解析 Shadowsocks (ss) 节点，其他类型节点将被跳过并给出原因。订阅链接含密钥，请勿分享给他人。',
      importSubscriptionUrlLabel: '订阅链接',
      importSubscriptionUrlPlaceholder: '粘贴订阅 URL',
      importSubscriptionUrlRequired: '请输入订阅链接',
      importSubscriptionPreview: '预览',
      importSubscriptionPreviewing: '预览中...',
      importSubscriptionBack: '返回修改',
      importSubscriptionConfirm: '确认导入',
      importSubscriptionImporting: '导入中...',
      importSubscriptionPreviewSummary: '预览结果：将创建 {created} 个，已存在 {updated} 个',
      importSubscriptionSkippedTitle: '不支持，已跳过 {count} 个',
      importSubscriptionDone: '导入完成：创建 {created} 个，已存在 {updated} 个',
      importSubscriptionFailed: '订阅导入失败',
      importSubscriptionPreviewFailed: '订阅预览失败',
      importSubscriptionClose: '完成',
      columns: {
        name: '名称',
        protocol: '协议',
        address: '地址',
