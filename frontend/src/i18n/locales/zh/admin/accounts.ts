export default {
    accounts: {
      ...
      dataImportPipelineScheduled: '{count} 个 grok 账号已进入后台刷新令牌+测试,失败将临时不可调度',
    ...
    recordsDelete: '删除',
    recordsDeleteConfirm: '确认删除这条巡检记录？',
    recordsClearAll: '清空全部记录',
    recordsClearAllConfirm: '确认清空全部巡检记录？此操作不可恢复。',
    recordsDeleted: '已删除',
    recordsCleared: '已清空 {count} 条记录',
    recordsDeleteFailed: '删除失败',
    recordsRetentionHint: '记录仅保留 7 天，超时自动清理。',
    openRecords: '巡检记录',
  ...
  upstreamBilling: {
      ...
      bulkActions: {
        ...
        selectAllFiltered: '选择符合当前筛选条件的全部 {count} 个账号',
        selectingAll: '正在选择...',
        allFilteredSelected: '已选择符合条件的全部 {count} 个账号',
        selectAllFailed: '选择筛选结果失败',
        clear: '清除选择',
        edit: '批量编辑选中账号',
        editFiltered: '按筛选条件批量编辑（{count}）',
        delete: '批量删除',
        enableScheduling: '批量启用调度',
        disableScheduling: '批量停止调度',
        resetStatus: '批量重置状态',
        setError: '批量设为错误',
        setErrorConfirm: '确认将选中的 {count} 个账号设为错误状态？将停止调度，需手动清错后恢复。',
        setErrorSuccess: '已将 {count} 个账号设为错误状态',
        refreshToken: '批量刷新令牌',
        test: '批量测试',
        testSuccess: '已完成 {count} 个账号测试,全部通过',
        testCompletedWithFailures: '批量测试完成:{success} 通过,{failed} 失败(失败账号已临时不可调度)',
        testDialogTitle: '批量测试',
        testDialogHint: '为每个平台选择测试模型;留空则使用该平台默认模型。',
        testDialogConfirm: '开始测试',
        testDialogLoadingModels: '加载模型中...',
        testDialogNoModels: '无可用模型,将使用平台默认',
        probeUpstreamBilling: '探测上游倍率',
        probingUpstreamBilling: '正在探测上游倍率...',
      ...
      bulkEdit: {
        ...
        filteredSelectionInfo: '将更新符合当前筛选条件的全部 {count} 个账号。只更新您勾选或填写的字段，未勾选的字段保持不变。',
      ...
      setError: '设为错误',
      setErrorConfirm: '确认将账号「{name}」设为错误状态？将停止调度，需手动清错后恢复。',
      setErrorSuccess: '账号已设为错误状态',
      setErrorFailed: '设为错误状态失败',
