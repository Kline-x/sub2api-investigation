...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Kline-x/sub2api-investigation/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Kline-x/sub2api-investigation"
...
Documentation=https://github.com/Kline-x/sub2api-investigation
